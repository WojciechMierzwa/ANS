window.onload = function() {
    ...
    setTimeout(() => { document.body.style.backgroundColor = "rgb(2, 83, 1)"; animloop() }, 10);
  ...
  SYSTEM = function () {
    ...
    // 61 = 58 (tree) + 3 (extra)
    var ParentParticle = new Parent(yearCoords.length + 61-3, 200, cnv.width / 2, cnv.height / 2);
    ParentParticle.born();
